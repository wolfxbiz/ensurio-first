          ...
          {industries.map((industry, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Text */}
                <div style={{ padding: '1.25rem 1.5rem', borderTop: '3px solid var(--teal)' }}>
                  <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: '1rem', fontWeight: 700, color: 'var(--navy)', marginBottom: '0.35rem' }}>
                    {industry.name}
                  </h3>
