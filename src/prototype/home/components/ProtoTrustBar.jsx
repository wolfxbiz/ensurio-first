...
export default function ProtoTrustBar() {
  return (
    <section style={{ background: 'var(--navy)', padding: '0' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1px', background: 'rgba(255,255,255,0.08)' }}>
        {trustStats.map((stat, i) => (
          ...
          >
            <div style={{ fontFamily: 'var(--font-heading)', fontSize: '2rem', fontWeight: 800, color: 'var(--teal)' }}>
              {stat.value}
            </div>
